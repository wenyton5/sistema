...
const ContactLists = () => {
  ...
  const handleDeleteContactList = async (contactListId) => {
    try {
      await api.delete(`/contactlists/${contactListId}`);
  ...
  const goToContacts = (id) => {
    history.push(`/contactlists/${id}/contacts`);
  };
                  ...
                  <TableCell align="center">
                    <a href={planilhaExemplo} download="planilha.xlsx">
                      <IconButton size="small" title="Baixar Planilha Exemplo">
                        <DownloadIcon style={{ color: "#ad8efa" }} />
                      </IconButton>
                    </a>
