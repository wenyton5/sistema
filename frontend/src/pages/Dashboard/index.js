...
card1: {
  ...
  flexDirection: "column",
  height: "100%",
  backgroundColor: "#ad8efa",
  color: "#eee",
  boxShadow: "none",  // Add this line to remove the box shadow
  borderRadius: 0, // Set the borderRadius to 0 to make it rectangular
