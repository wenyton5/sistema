...
const Copyright = () => {
  return (
    <Typography variant="body2" color="textSecondary" align="center" style={{ color: '#e0970d' }}>
	...
	return (
		<Container component="main" maxWidth="xs">
			...
			<Box mt={8} textAlign="center">
                          {/* O link para a página do Facebook */}
                          <a href="https://www.facebook.com/sua_pagina" target="_blank" rel="noopener noreferrer">
                          <button style={{ backgroundColor: '#4267B2', color: 'white', padding: '10px 20px', border: 'none', borderRadius: '4px', cursor: 'pointer' }}>
